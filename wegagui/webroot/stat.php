...
//     if (!$AirHum){
//         echo "<td><a href=plotdb.php?ns=".$ns."&cl=".urlencode($p_AirHum).">Датчик влажности воздуха</a><td>Нет данных<td>Проблема</tr>";
//     }
//     else{
...
//     if (!$AirTemp){
//         echo "<td><a href=plotdb.php?ns=".$ns."&cl=".urlencode($p_AirTemp).">Датчик температуры воздуха</a><td>Нет данных<td>Проблема</tr>";
//     }
//     else{
...
//     if (!$RootTemp){
//         echo "<td><a href=plotdb.php?ns=".$ns."&cl=".urlencode($p_RootTemp).">Датчик температуры корней</a><td>Нет данных<td>Проблема</tr>";
//     }
//     else{
...
//     if (!$WaterTemp){
//         echo "<td><a href=plotdb.php?ns=".$ns."&cl=".urlencode($p_WaterTemp).">Датчик температуры раствора в баке</a><td>Нет данных<td>Проблема</tr>";
//     }
//     else{
...
//     if (!$ec){
//         echo "<td><a href=plotdb.php?ns=".$ns."&cl=".urlencode($p_ec).">Датчик ЕС</a><td>Нет данных<td>Проблема</tr>";
//     }
//     else{
...
//     if (!$Lux){
//         echo "<td><a href=plotdb.php?ns=".$ns."&cl=".urlencode($p_Lux).">Датчик освещенности</a><td>Нет данных<td>Проблема</tr>";
//     }
//     else{
//     echo "<td><a href=plotdb.php?ns=".$ns."&cl=".urlencode($p_Lux).">Освещенность</a><td>".round($Lux,1)." kLux<td></tr>";
//     }
// }
...
//    if (!$CO2){
//     echo "<td><a href=plotdb.php?ns=".$ns."&cl=".urlencode($p_CO2).">Датчик CO2</a><td>Нет данных<td>Проблема</tr>";
// }
// else{
...
//     if (!$lev){
//         echo "<td><a href=plotdb.php?ns=".$ns."&cl=".urlencode($p_lev).">Датчик уровня раствора</a><td>Нет данных<td>Проблема</tr>";
//     }
//     else{
...
echo sensval_s("Dist",50000,$ns)->Dist ;
echo "<br>";
echo sensval_s("Dist",50000,$ns)->dt ;
echo "<br>";
echo sensval_s("Dist",60,$ns)->Dist ;
echo "<br>";
echo sensval_s("Dist",60,$ns)->dt ;
