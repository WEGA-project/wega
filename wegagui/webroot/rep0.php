...
$ml = 0;
if ($p_AirTemp != "null" or $p_RootTemp != "null" or $p_ECtempRAW != "null"){ $ml = 1; }
//if ($p_RootTemp != "null"){ $ml = 1; }
//if ($p_ECtempRAW != "null"){ $ml = 1; }

if ($p_AirHum != "null"){ $ml = $ml+1; }

if ($p_LightRaw != "null"){ $ml = $ml+1; }

if ($p_pHraw != "null"){ $ml = $ml+1; }

if ($p_A1 != "null" and $p_A2 != "null"){ $ml = $ml+1; }

if ($p_Dst != "null"){ $ml = $ml+2; }


$xsize=1200;
$ysize=500*$ml;

echo '<br>'. $xsize.' '.$ysize.' '.$gimg.' '.$wsdt.' '.$wpdt.' '.$csv ;
