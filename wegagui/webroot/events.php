...
if ( $_GET['ns'] ){
    ...
    pedit("Ev_Max_AirTemp",$ns,35,"Максимальная температура воздуха");
    pedit("Ev_Min_AirTemp",$ns,10,"Минимальная температура воздуха");
    pedit("Ev_Max_WaterTemp",$ns,28,"Максимальная температура раствора");
    pedit("Ev_Min_WaterTemp",$ns,15,"Минимальная температура раствора");
    pedit("Ev_Max_RootTemp",$ns,28,"Максимальная температура корней");
    pedit("Ev_Min_RootTemp",$ns,15,"Минимальная температура корней");
    pedit("Ev_Max_AirHum",$ns,80,"Максимальная влажность воздуха");
    pedit("Ev_Min_AirHum",$ns,10,"Минимальная влажность воздуха");
    pedit("Ev_Max_AirPress",$ns,800,"Максимальное давление воздуха");
    pedit("Ev_Min_AirPress",$ns,700,"Минимальное давление воздуха");    
