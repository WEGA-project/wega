...
form($ns,"pHraw","Датчик pH (<b>выбирать из списка обязательно pHmV, не pHraw</b>)");
...
form($ns,"AirPress","Давление воздуха");
form($ns,"Dst","Уровнемер (см)");
form($ns,"IntTempRaw","Температура внутри корпуса контроллера");
form($ns,"VddRaw","Напряжение питания");
form($ns,"CO2","Уровень CO2 в ppm");
form($ns,"tVOC","Индекс летучих органических соединений tVOC");
}
